...
def get_jalali(any_date):
    result = khayyam.JalaliDatetime.now().strftime(fields.DATETIME_FORMAT)

    if type(any_date) is datetime:
        if isinstance(any_date, datetime):
            # print("get_jalali 1:" + str(any_date))
            result = khayyam.JalaliDatetime(any_date).strftime(fields.DATETIME_FORMAT)
            # print(str(any_date) + "=>" + str(result))
        else:
            # print("get_jalali 2:" + str(any_date))
            result = khayyam.JalaliDate(any_date).strftime(fields.DATE_FORMAT)
            # print(str(any_date) + "=>" + str(result))
    else:
        miladi_date = ""
        if is_time_string(any_date):
            if "-" in any_date:
                # print("get_jalali 4:" + str(any_date))
                miladi_date = datetime.strptime(any_date,fields.DATETIME_FORMAT)
                result = khayyam.JalaliDatetime(miladi_date).strftime(fields.DATETIME_FORMAT)
                # print(str(any_date) + "=>" + str(result))
            else:
                # print("get_jalali 5:" + str(any_date))
                miladi_date = datetime.strptime(any_date,fields.DATETIME_FORMAT)
                result = khayyam.JalaliDatetime(miladi_date).strftime(fields.DATETIME_FORMAT)
                # print(str(any_date) + "=>" + str(result))
        else:
            if "-" in any_date:
                # print("get_jalali 6:" + str(any_date))
                miladi_date = date.strptime(any_date,fields.DATE_FORMAT)
                result = khayyam.JalaliDate(miladi_date).strftime(fields.DATE_FORMAT)
                # print(str(any_date) + "=>" + str(result))
            else:
                # print("get_jalali 7:" + str(any_date))
                miladi_date = date.strptime(any_date,fields.DATE_FORMAT)
                result = khayyam.JalaliDate(miladi_date).strftime(fields.DATE_FORMAT)
                # print(str(any_date) + "=>" + str(result))
...
def get_miladi(any_date):
    result = khayyam.JalaliDatetime.now().todatetime().strftime(fields.DATETIME_FORMAT)

    if type(any_date) is khayyam.JalaliDatetime:
        if (any_date.time):
            # print("get_miladi 1:" + str(any_date))
            result = khayyam.JalaliDatetime(any_date).todatetime().strftime(fields.DATETIME_FORMAT)
            # print(str(any_date) + "=>" + str(result))
        else:
            # print("get_miladi 2:" + str(any_date))
            result = khayyam.JalaliDate(any_date).todate().strftime(fields.DATE_FORMAT)
            # print(str(any_date) + "=>" + str(result))
    else:
        jalali_date = ""
        if is_time_string(any_date):
            if "-" in any_date:
                # print("get_miladi 3:" + str(any_date))
                jalali_date = khayyam.JalaliDatetime.strptime(any_date,fields.DATETIME_FORMAT)
                result = khayyam.JalaliDatetime(jalali_date).todatetime().strftime(fields.DATETIME_FORMAT)
                # print(str(any_date) + "=>" + str(result))
            else:
                # print("get_miladi 4:" + str(any_date))
                jalali_date = khayyam.JalaliDatetime.strptime(any_date,fields.DATETIME_FORMAT)
                result = khayyam.JalaliDatetime(jalali_date).todatetime().strftime(fields.DATETIME_FORMAT)
                # print(str(any_date) + "=>" + str(result))
        else:
            if "-" in any_date:
                # print("get_miladi 5:" + str(any_date))
                jalali_date = khayyam.JalaliDate.strptime(any_date,fields.DATE_FORMAT)
                result = khayyam.JalaliDate(jalali_date).todate().strftime(fields.DATE_FORMAT)
                # print(str(any_date) + "=>" + str(result))
            else:
                # print("get_miladi 6:" + str(any_date))
                jalali_date = khayyam.JalaliDate.strptime(any_date,fields.DATE_FORMAT)
                result = khayyam.JalaliDate(jalali_date).todate().strftime(fields.DATE_FORMAT)            
                # print(str(any_date) + "=>" + str(result))
...
def is_time_string(input_string):
    try:
