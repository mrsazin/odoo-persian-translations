...
class PosPayment(models.Model):
    ...
    payment_date = myfields.Datetime(string='Date', required=True, readonly=True, default=lambda self: myfields.Datetime.now())
    ...
    def _create_payment_moves(self, is_reverse=False):
        ...
        for payment in self:
            ...
            payment_move = self.env['account.move'].with_context(default_journal_id=journal.id).create({
                ...
                'date': myfields.Date.context_today(order, order.date_order),
