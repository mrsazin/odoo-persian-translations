...
def correct_date(date_obj):
    try:
        ...
        if isinstance(date_obj, date):
            ...
            if dec != '12' and dec !='13' and dec != '14' and dec != '15' and dec != '16':
                if len(date_obj) > 10:
                    return datetime.strptime(date_obj, DATETIME_FORMAT)
                else:
                    return datetime.strptime(date_obj, DATE_FORMAT)
            else:
                if len(date_obj) > 10:
                    return JalaliDatetime.strptime(date_obj, DATETIME_FORMAT)
                else:
                    return JalaliDate.strptime(date_obj, DATE_FORMAT)
